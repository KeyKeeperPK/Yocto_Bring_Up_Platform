...
PLATFORMS:
    ...
    raspberrypi5bare Raspberry Pi 5 baseline boot validation
...
EXAMPLES:
    ...
    pk build raspberrypi5bare               # Build Pi 5 baseline boot image
...
QUICK BUILDS:
    ...
    pk build raspberrypi5bare               # ~30-60 minutes
